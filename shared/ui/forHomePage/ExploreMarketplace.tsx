      ...
      <Container className="flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-4 max-lg:grid-cols-2 max-md:grid-cols-1 grid-rows-2 gap-8 justify-center mt-16">
          {ExploreList.map((item) => (
            <div
              key={item.id}
              className="flex flex-col justify-center w-64 h-full py-4 bg-white shadow-[0_0_25px_rgba(0,0,0,0.2)] rounded-2xl items-center gap-3">
              <div className="relative">
                <div className="absolute top-3 left-[53%] bg-[rgba(28,29,32,0.35)] rounded-xl text-white text-sm px-2 py-2">
                  {item.time}
                </div>
                <Image
                  src={item.image}
              ...
              <div className="font-bold text-lg mr-auto px-4">{item.name}</div>
              ...
              <div className="flex items-center justify-center gap-8">
                ...
                <button className="ml-auto text-white font-semibold bg-black px-4 py-3 rounded-2xl cursor-pointer transition-all duration-300 hover:bg-white hover:text-black">
                  Place Bid
                </button>
              </div>
            </div>
